...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.carousel = function () {
  for (let i = 0; i < this.length; i++) {
    const width = window.getComputedStyle(this[i].querySelector('.carousel-inner')).width; // Ширина обертки 

    const slides = this[i].querySelectorAll('.carousel-item'); // Коллейкция слайдов

    const slidesField = this[i].querySelector('.carousel-slides');
    const dots = this[i].querySelectorAll('.carousel-indicators li');
    slidesField.style.width = 100 * slides.length + '%'; // Дали ширину контейнеру слайдов 
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i].querySelector('[data-slide="next"]')).click(e => {
      e.preventDefault();
      console.log(+width.replace(/\D/g, '') * (slides.length - 1), offset, slideIndex, slides.length - 1);
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.tab = function () {
  for (let i = 0; i < this.length; i++) {
    this[i].addEventListener('click', () => {
      console.log(Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]));
      console.log(this[i]); // console.log($('[data-tabpanel] .tab-item'));
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.eq = function (i) {
  const swap = this[i];
  const objLength = Object.keys(this).length; // Из объекта в массив + сразу берем длину
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.index = function () {
  const parent = this[0].parentNode; // Родителя

  const childs = [...parent.children]; // В массив
...
$('#trigger').click(() => $('#trigger').createModal({
  ...
  btns: {
    ...
    }], ['djskdj', ['btn-warning', 'ml-10'], false, () => {
      alert('OK');
    }]]
  }
}));
